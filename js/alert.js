                    ...
                    swal(
                      {
                        ...
                        animation: "slide-from-top",
                        inputPlaceholder:
                          "Nhớ viết hoa đầu dòng với Tết viết hoa đầu chữ nhá :",
                      },
                      function (inputValue) {
                        if (inputValue === false) return false;
                              ...
                              setTimeout(function () {
                                swal(
                                  ...
                                  function (inputValue) {
                                    ...
                                    if (inputValue === "") {
                                      swal.showInputError(
                                        "Không thể để trống được "
                                      );
                                      return false;
                                    }
                                    swal(
                                      "Tuyệt vời!",
                                      "" + inputValue + " bạn đỉnh thật ",
                                      "success"
                                    );
                                  }
                                );
...
function tom_orion() {
    swal({
      ...
      text: "bạn vừa nhận được một lời chúc vào ngày sinh nhật của mình ",
      imageUrl:
        "https://photos.google.com/u/0/photo/AF1QipM2H7Md-n58A0x2v6wu7bofFAkhuYHhDee0Lv__?hl=vi",
      confirmButtonClass: "btn__gift1",
    ...
    function (isConfirm) {
      if (isConfirm) {
        swal({
          title: ":3",
          text:
            "Happy Birthday! Tuổi mới chúc phucboy tiền đầy túi, tình đầy tim, bớt đẹp trai lại cho anh em còn có cửa nhờ nhé. Mong năm nay làm gì cũng mượt, đi trap ít thôi không các em lại khổ",
          type: "success"
        });
      }
    });
